...
* `get_item_weight(item: ItemStack) -> float` - Returns the weight of the given item (i.e. the `weight` property).
* `set_item_weight(item: ItemStack, weight: float) -> void` - Sets the weight of the given item (i.e. the `weight` property).
