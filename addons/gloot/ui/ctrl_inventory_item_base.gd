...
##
## `CtrlInventoryItemBase` defines some signals and members used for displaying an `ItemStack`. Must be inherited
...
## Reference to the `ItemStack` that is being displayed.
